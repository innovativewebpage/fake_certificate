          ...
          <div class="d-flex align-items-center">
            ...
            <div class="mr-auto">
              ...
              >
                ...
                >
                  <li class="active">
                    <a href="dashboard.php" class="nav-link text-left"
                      ><span class="icon-users"></span> Dashboard</a
                    >
                  </li>
          
                  <li >
                    <a href="login.html" class="nav-link text-left">Add Certificates</a>
                  </li>
                  <li>
            ...
            <div class="col-md-12">
              <div class="row">
                    <div class="col-md-4 form-group">
                     ...
                     <div class="col-md-8 ">  
                      : <span class="bold m-l-10"><?php echo htmlspecialchars($row['name']); ?> </span>              
                    </div>
                </div>
                   <div class="row">
                    <div class="col-md-4 form-group">
                     ...
                     <div class="col-md-8 ">  
                      :  <span class="bold m-l-10"><?php echo htmlspecialchars($row['reg_id']); ?> </span>              
                    </div>
                </div>
                 ...
                 <div class="row">
                    <div class="col-md-4 form-group">
                     ...
                     <div class="col-md-8 ">  
                      :  <span class="bold m-l-10"><?php echo htmlspecialchars($row['email']); ?> </span>              
                    </div>
                </div>
                    ...
                    <div class="col-md-4 form-group">
                     ...
                     <div class="col-md-8 ">  
                      :  <span class="bold m-l-10"><?php echo htmlspecialchars($row['mobile']); ?> </span>              
                    </div>
                </div>
